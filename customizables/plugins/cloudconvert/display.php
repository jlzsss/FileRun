...
<div id="selectFormat">
	...
	foreach ($rs as $format) {
		?>
		<div class="format" data-format="<?php echo S::safeHTML($format['outputformat']);?>" style="background-image:url('<?php echo \FileRun\UI\Utils::getFileIconURL(false, $format['outputformat']);?>')">
